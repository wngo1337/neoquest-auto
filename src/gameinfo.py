...
equipment_names_to_recipes = {"Energy Shield": (
    ...
    "Magic Robe": (
        210011, 90010005, ("cave lupe pelt", "stretch of rotted cloth", "tiny obsidian",
                           "glowing stone")
    ),
    "Steel Wand": (
        200006, 90010004, ("tiny lapis", "corroded pewter rod", "glowing stone", "Xantan's Ring")
    ),
    "Glacier Wand": (
        200011, 90030001, ("shamanistic totem", "skeith fang", "jungle vambrace", "glowing stone",
                           "the Staff of Ni-tas")
    ),
    "Robe of Protection": (
        210013, 90070001, ("drakonid eye", "drakonid hide", "drakonid heart")
    ),
    # TRIES TO ITERATE OVER THE STRING IF YOU ONLY HAVE ONE INGREDIENT
    "Keladrian Medallion": (
        230074, 90010008, ("rusty medallion",)
    ),
    ...
    "Silver Wand": (
        200009, 90010004, ("tiny beryl", "corroded aluminum rod", "glowing stone", "Xantan's Ring")
    ),
    # THIS IS STILL A FILLER ID BTW
    "Nature Wand": (
        200014, 90030001, ("jungle beast claw", "jungle pauldrons", "noil's tooth", "glowing stone",
                           "the Staff of Ni-tas")
    ),
    "Moonstone Staff": (
        200024, -1, tuple()
...
travel_locations_to_paths = {"eleusToDankCave": "4444444444411112",
                          ...
                          "jungleRuinsDenethrirToF3": "555322222222355553227788888832235355577"
                                                      "77788555555",
                          ...
                          "kalPanningToFaleinn": "2222222222222231222222222222232233555555533333555"
                                                 "333322",
                          ...
                          # Arrive at cave 1
                                            "66444414444467776666777787877764444"
                                            "5885"
                          # Now at cave 3?
