...
direction_urls_to_numbers = {URL: movementString for
                               movementString, URL in constants.numbers_to_direction_urls.items()}
...
class PathTracker:
        ...
        while True:
            ...
            if userInput.lower() == "c":
                ...
                if self.current_address in direction_urls_to_numbers:
                    self.current_path = self.current_path + direction_urls_to_numbers[
                        self.current_address]
    ...
    def invert_path(self, original_path):
        ...
        original_directions_to_inverted = {"1":"8", "2":"7", "3":"6", "4":"5", "5":"4",
                                      "6":"3", "7":"2", "8":"1"}
